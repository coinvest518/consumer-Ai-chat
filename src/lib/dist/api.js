...
exports.api = {
    getChatLimits: function (userId) { return __awaiter(void 0, void 0, Promise, function () {
        var session, token, endpoints, lastError, _i, endpoints_1, endpoint, headers, response, data, parseError_1, errorData, fetchError_1, error_1;
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    _c.label = 2;
                case 2:
                    if (!(_i < endpoints_1.length)) return [3 /*break*/, 15];

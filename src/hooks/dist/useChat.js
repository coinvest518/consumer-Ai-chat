...
function useChat() {
    ...
    var sendMessage = react_1.useCallback(function (userInput) { return __awaiter(_this, void 0, void 0, function () {
        var userMessage, response, errorData, jsonErr_1, errorText, _a, result_1, botMessage_1, err_1, errorMessage_1;
        var _b;
            ...
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, fetch(config_1.API_BASE_URL + "/chat", {
                            ...
                            body: JSON.stringify({
                                message: userInput,
                                sessionId: ((_b = messages[0]) === null || _b === void 0 ? void 0 : _b.id) || Date.now().toString(),
                ...
                case 12:
                    ...
                    if (typeof result_1.chatsUsed === 'number') {
                        setChatLimits(function (prev) { return (__assign(__assign({}, prev), { chatsUsedToday: result_1.chatsUsed, dailyLimit: result_1.dailyLimit || prev.dailyLimit // This line is correct if result comes from ChatResponse, but if you use UserMetrics, use daily_limit
                         })); });
                        // Update localStorage
                        if (user === null || user === void 0 ? void 0 : user.id) {
                            localStorage.setItem("chatLimits-" + user.id, JSON.stringify({
                                dailyLimit: result_1.dailyLimit,
                                chatsUsedToday: result_1.chatsUsed,
                ...
                case 14:
                    ...
                    setMessages(function (prevMessages) { return __spreadArrays(prevMessages, [errorMessage_1]); });
                    return [3 /*break*/, 16];
                case 15:
                    setIsLoading(false);
                    return [7 /*endfinally*/];

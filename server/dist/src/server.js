...
import { callAgentAPI, clearChatSessionMemory, clearAllChatSessionMemories } from './dispute-ai.js';
...
app.delete('/api/chat/sessions', (_, res) => {
    ...
    try {
        ...
        try {
            ...
            if (!astraMetrics) {
                ...
                await updateUserMetrics(userId, legacyMetrics); // Legacy format for Astra

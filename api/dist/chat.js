...
function handler(req, res) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var allowedOrigins, origin, _b, message, sessionId, userId, response, error_1;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    _c.trys.push([1, 3, , 4]);
                    _b = req.body, message = _b.message, sessionId = _b.sessionId, userId = _b.userId;
                ...
                case 2:
                    ...
                    console.log('Chat response sent:', {
                        userId: userId,
                        sessionId: sessionId,
                        responseLength: (_a = response === null || response === void 0 ? void 0 : response.text) === null || _a === void 0 ? void 0 : _a.length,
                        timestamp: new Date().toISOString()
                    });
                    res.json(response);
                    return [3 /*break*/, 4];
